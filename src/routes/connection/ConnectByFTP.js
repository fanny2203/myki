            ...
            { detailsFirstStep && (
                <>
                    ...
                    <div className="newConnection-form">
                        ...
                        {/* User */}
                        <label className="lbl-purple">User*</label>
                        <TextField hiddenLabel variant="standard" placeholder="User" />

                        {/* Password */}
                        <label className="lbl-purple">Password*</label>
                        <TextField 
                            hiddenLabel 
                            variant="standard" 
                            ...
                            InputProps={{
                                endAdornment: <InputAdornment position="end"><img src={pwdIcon} alt="show pwd" className="input-copyIcon pointer" onClick={() => setShowPassword(!showPassword)}/></InputAdornment>,
                              }}
                        />

                        {/* Host Address */}
                        <label className="lbl-purple">Host Address*</label>
                        <TextField hiddenLabel variant="standard" placeholder="Host Address" />

                        {/* Port */}
                        <label className="lbl-purple">Port*</label>
                        <TextField hiddenLabel variant="standard" placeholder="Port" />

                        {/* Secure FTP */}
                        <label className="lbl-purple">Secure FTP </label>
                        <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} />}/>
                        <FormHelperText>Turn the toggle on if your FTP server uses the FTPS protocol. Otherwise, you can keep it off.</FormHelperText>
            ...
            { detailsSecondStep && (
                <>
                    ...
                    <div className="newConnection-form">
                        ...
                        {/* Send emails */}
                        <label className="lbl-purple">Send your emails to</label>
                        <TextField hiddenLabel variant="standard" placeholder="email@example.com" />
